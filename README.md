...
The design is a **planner / doer / checker** loop: a long-lived agent system
isn't one prompt, it's a cycle that makes measurable progress toward a goal and
corrects itself with real feedback.
